...
def pretrain(model, dataloader):
    ...
    while True:
        for batch in dataloader:
            ...
            customer_features = torch.cat((customer_features_1, customer_features_2), dim=1)
            state = (edge_indices, in_route_features, customer_features,
...
if __name__ == '__main__':
    ...
    model = Policy(learn_quadratic=args.learn_quadratic, ks=top_ks)
    ...
    for epoch in range(max_epochs + 1):
        ...
        if epoch == 0:
            ...
            model.save_state('models/epoch.%d.pkl'%epoch)
